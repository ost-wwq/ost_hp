...
class ViewingReservationMail extends Mailable
{
    ...
    {
        return new Envelope(subject: '【内見予約完了】' . $this->reservation->property->title);
    }

    public function content(): Content
    {
        return new Content(view: 'emails.viewing_reservation');
    }
}
